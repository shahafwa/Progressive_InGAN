...
class Config:
    def __init__(self):
        ...
        # Paths
        self.parser.add_argument('--input_image_path', default=[os.path.dirname(os.path.abspath(__file__)) + '/fruits.png'], nargs='+', help='path to one specific image file')
        ...
        self.parser.add_argument('--G_num_resblocks', type=int, default=11, help='# of resblocks in G\'s bottleneck')
        ...
        self.parser.add_argument('--D_max_num_scales', type=int, default=9, help='Limits the # of scales for the multiscale D')
        self.parser.add_argument('--D_scale_factor', type=float, default=1.4142, help='Determines the downscaling factor for multiscale D')
        self.parser.add_argument('--D_scale_weights_sigma', type=float, default=4, help='Determines the downscaling factor for multiscale D')
        self.parser.add_argument('--D_min_input_size', type=int, default=4, help='Determines the downscaling factor for multiscale D')
        self.parser.add_argument('--D_scale_weights_iter_for_even_scales', type=int, default=45000, help='Determines the downscaling factor for multiscale D')
        ...
        self.parser.add_argument('--iter_for_max_range', type=int, default=78000, help='In curriculum learning, when getting to this iteration all range is covered')
        self.parser.add_argument('--stage_factor', type=float, default=2, help='what is the factor in each stage')
        self.parser.add_argument('--stage_size', type=int, default=4, help='how many stages do we use')
        ...
        self.parser.add_argument('--max_scale', type=float, default=1.4, help='max retargeting scale')
        self.parser.add_argument('--min_scale', type=float, default=0.5, help='min retargeting scale')
        ...
        # Iterations
        self.parser.add_argument('--max_iters', type=int, default=1000, help='max # of iters')
        ...
        self.parser.add_argument('--stage_iters', type=int, default=1600, help='# iters per stage')
        ...
        self.parser.add_argument('--G_extra_inverse_train_start_iter', type=int, default=15000, help='number of extra training iters for G on inverse direction')
